...
\[\lim_{n\to\infty} \frac{T(n)}{n} = 0\]
in their paper \cite{HM81}. We can use this result when $T(n)$ is a monotone increasing function as well \cite{HM81}. Hence, this is a consequence of Theorem \ref{closed}, because $1NL$ is also closed under deterministic two-way logarithmic space reduction.
\end{proof}
