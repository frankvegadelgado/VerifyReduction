...
Sauerhoff has investigated the class $BNL$ of languages recognizable by nondeterministic logarithmic space Turing machine, that only use nondeterministic moves before reading their input ($``$nondeterminism at the beginning$"$) \cite{MS03}.
