...
\begin{theorem}
\label{argument}
If the Hypothesis \ref{hypothesis} is true, then $L = NL$ and $P = NP$ cannot be both true or false at the same time and thus, $L \neq NP$.
\end{theorem}
...
\begin{theorem}
$L = NL$ and $P = NP$ cannot be both true or false at the same time and thus, $L \neq NP$.
\end{theorem}
