...
\[\lim_{n\to\infty} \frac{T(n)}{n} = 0\]
in their paper \cite{HM81}. Consequently, this is a consequence of Theorem \ref{closed}, because $1NL$ is also closed under deterministic two-way logarithmic space reduction.
\end{proof}
