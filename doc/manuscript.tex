...
\begin{theorem}
\label{argument}
If the Hypothesis \ref{hypothesis} is true, then there is an $\textit{NP--complete}$ language which complies with the definition of $NL$, and therefore $P = NP$.
\end{theorem}
