...
INSTANCE: A collection of integers (positive or negative) $C$ such that $0 \notin C$ and every integer in $C$ has the same bit-length of the number that represents the cardinality of $C$ multiplied by $3$ (we fill with zeroes to the left the elements in case of necessity).
